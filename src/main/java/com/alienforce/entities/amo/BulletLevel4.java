...
/// {@inheritDoc}
public class BulletLevel4 extends GameObject implements Bullet {

    private final static Image sprite = getImage(ImageKey.BULLET_4).get();

    @Getter
    private final SelfDefendable owner;

    // CONSTRUCTOR:
    public BulletLevel4(final Position position, final Velocity velocity, final double rotationAngle, final SelfDefendable owner) {
