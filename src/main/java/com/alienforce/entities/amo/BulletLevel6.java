...
/// {@inheritDoc}
public class BulletLevel6 extends GameObject implements Bullet {

    private final static Image sprite = getImage(ImageKey.BULLET_6).get();

    @Getter
    private final SelfDefendable owner;

    // CONSTRUCTOR:
    public BulletLevel6(final Position position, final Velocity velocity, final double rotationAngle, final SelfDefendable owner) {
