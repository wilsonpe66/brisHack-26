...
/// {@inheritDoc}
public class BulletLevel5 extends GameObject implements Bullet {

    private final static Image sprite = getImage(ImageKey.BULLET_5).get();

    @Getter
    private final SelfDefendable owner;

    // CONSTRUCTOR:
    public BulletLevel5(final Position position, final Velocity velocity, final double rotationAngle, final SelfDefendable owner) {
