...
public enum ImageKey implements AssetKey {
    ...
    ICON_32("icon/32.png"),
    ICON_64("icon/64.png"),
    EXPLOSION_1("explosion/1.png"),
    EXPLOSION_2("explosion/2.png"),
    EXPLOSION_3("explosion/3.png"),
    ...
    PLANET_1("planet/ocean.png"),
    PLANET_2("planet/rocky.png"),
    PLANET_3("planet/volcanic.png"),
