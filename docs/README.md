# (git) Push To Orbit — Documentation

Welcome to the docs for **(git) Push To Orbit**, a Java Swing Asteroids-style arcade game built at BrisHack 2026.
...
| [Constants & Tuning](constants.md)           | Every tunable value (speeds, sizes, cooldowns, etc.)                                                |
| [Building & Running](building.md)            | How to compile, package, and run the game                                                           |
